...
public class LoadingActivity extends BaseActivity {
    ...
    private void showAd(){
        splashAD = new  SplashAD(this, findViewById(R.id.active_image), "1108219810", "6010768033072652", new SplashADListener() {
            @Override
